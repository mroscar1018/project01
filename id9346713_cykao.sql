...
--
ALTER TABLE `member`
  MODIFY `shopid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
--
...
--
ALTER TABLE `signup`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT COMMENT '流水編號', AUTO_INCREMENT=35;
